...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Adauga medicament nou') }}</div>
                ...
                <div class="card-body">
                  <form action="{{route('medicines.store')}}" method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input id="medicinecode" type="text" class="form-control @error('medicinecode') is-invalid @enderror" name="medicinecode" value="{{ old('medicinecode') }}" required autocomplete="medicinecode" autofocus>
