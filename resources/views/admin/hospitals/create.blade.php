...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Adauga clinica noua') }}</div>
                ...
                <div class="card-body">
                  <form action="{{route('hospitals.store')}}" method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input id="fiscalcode" type="text" class="form-control @error('fiscalcode') is-invalid @enderror" name="fiscalcode" value="{{ old('fiscalcode') }}" required autocomplete="fiscalcode" autofocus>
